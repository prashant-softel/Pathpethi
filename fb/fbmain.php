<?php
	...
	$fbconfig['baseurl']  = "http://way2society.com/login.php";
	
	if(isset($_REQUEST['mCode'])  && $_REQUEST['mCode'] <> "")
	{
		$fbconfig['baseurl']  = "http://way2society.com/login.php?c=".$_REQUEST['mCode'];
	}
	else if(isset($_REQUEST['c'])  && $_REQUEST['c'] <> "")
	{
		$fbconfig['baseurl']  = "http://way2society.com/login.php?c=".$_REQUEST['c'];
	}
