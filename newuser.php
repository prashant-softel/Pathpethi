...
$FBCallBackURL = FB_BASE_APP_URL . "newuser.php?";
...
if (isset($_REQUEST['mode']) && $_REQUEST['mode'] == 'verify') {
	...
	if ($result > 0) {
		...
		$msg = 'E-Mail ID [' . $_REQUEST['email'] . '] Is Already Registered.<br><a href="forgotpassword.php">Forgot Password</a>';
	}
	...
	<center>
		...
		<div id="no_fb" style="display:block;background-color: #f2f2f2;border-radius: 20px;padding: 20px;width: 50%;">
			...
			<div style="background-color:#FFF;border-radius: 10px;line-height: 40px;">
				...
				<form name="verify_code" method="post" action="<?php echo $FBCallBackURL; ?>" onSubmit="return varifyForm();" style="width:28vw;">
					<fieldset>
						<input type="hidden" name="mode" value="verify" />
						<input type="hidden" name="fb_id" id="fb_id" value="<?php if (sizeof($fb_details) > 0 && $fb_details['fbid'] <> '') {
																				echo $fb_details['fbid'];
																			} else {
																				echo '0';
																			} ?>" />
						<?php echo "<!-- fb_details:\n" . sizeof($fb_details) . print_r($fb_details, TRUE) . "\n-->\n\n"; ?>
						...
						<table class="form-group" style="width:30vw;">
							<tr height="30">
								<td colspan="3" align="center">
									<font color="red" style="size:11px;"><b id="error"></b></font>
								</td>
							</tr>
							<tr>
								<td colspan="3" align="justify" id="info"></td>
							</tr>
							...
							<!--<tr>
                        <td>Security Code<?php //echo $star;
											?></td><td>:&nbsp;</td>
                        <td><input type="text" name="code" id="code" /></td>
                    </tr>-->

							<!-- <tr>
                        <td><span style="font-size:1vw;">Mobile Number<?php //echo $star;
																		?></span></td>
                        <td>:&nbsp;</td>
                        <td><input    name="mob" id="mob" type="text" class="form-control"  maxlength="10"  pattern="[0-9]{10}" value="<?php //echo $_REQUEST['mob']; 
																																		?>"  title="Enter your 10 digit mobile number." onKeyPress='return blockNonNumbers(this, event, false, false);' style="height:35px; width: 14.8vw;"></td>
                    </tr>-->
							...
							<!-- <tr>
                    	<td><span style="font-size:1vw;">Society Name<?php //echo $star;
																		?></span> </td>
                    	<td>&nbsp; : &nbsp;</td>
                    	<td><input type="text" class="form-control"  name="society_name" id="society_name" value="<?php //echo $_REQUEST['society_name'];
																													?>" style="height:35px; width: 14.8vw;"/></td>
                    </tr>
                    
                    <tr>
                            <td><span style="font-size:1vw;">Wing Name<?php //echo $star;
																		?></span> </td>
                            <td>&nbsp; : &nbsp;</td>
                            <td><input type="text" class="form-control"  name="wing" id="wing" value="<?php //echo $_REQUEST['wing'];
																										?>" style="height:35px; width: 14.8vw;"/></td>
                    </tr>
                    
                    
                    <tr>
                            <td><span style="font-size:1vw;">Unit/Flat/Shop No<?php //echo $star;
																				?></span> </td>
                            <td>&nbsp; : &nbsp;</td>
                            <td><input type="text"  class="form-control" name="unit" id="unit" value="<?php //echo $_REQUEST['unit'];
																										?>" style="height:35px; width: 14.8vw;"/></td>
                    </tr>-->
							...
							<tr>
								<td colspan="3" align="center" style="padding:10px;">
									<p style="float: none;clear: both;vertical-align: middle; border: 1px solid rgb(204, 204, 204)">
										<input style="float:none; vertical-align: middle;margin-bottom: 5px;" type="checkbox" id="agree" onchange="activateButton(this);" />
										<label style="display:inline; float:none" for="agree">
											I agree with the <a href="http://way2society.com/?page_id=5640" target="popup" onclick="window.open('https://way2society.com/?page_id=5640','popup','width=600,height=600,scrollbars=yes'); return false;">terms and conditions</a>.
										</label>
									</p>
