        ...
        <tr height="30"><td colspan="4" align="center"><font color="red" style="size:11px;"><b id="error"><?php echo $msg?></b></font></td></tr>
         <tr height="30"><td colspan="4" align="center"><font color="blue" style="size:11px;"><b>Kindly enter your society details to receive an account activation email.</b></font></td></tr>
            <tr align="left">
                    ...
                    <td>&nbsp; : &nbsp;</td>
                    <td><input type="text" name="society_name" id="society_name" value="<?php echo $_REQUEST['society_name'];?>"/></td>
            </tr>
            
            <tr align="left">
                    <td valign="middle"></td>
                    <th>Wing Name<?php //echo $star;?> </th>
                    <td>&nbsp; : &nbsp;</td>
                    <td><input type="text" name="wing" id="wing" value="<?php echo $_REQUEST['wing'];?>"/></td>
            </tr>
            ...
            <tr align="left">
                    ...
                    <td>&nbsp; : &nbsp;</td>
                    <td><input type="text" name="unit" id="unit" value="<?php echo $_REQUEST['unit'];?>"/></td>
            </tr>
            
            <tr><td><br /></td></tr>
            <tr align="center">
                    <td valign="middle"  colspan="4"> <input   name="submit" id="submit" value="Submit" type="submit" class="btn btn-primary"></td>
            </tr>
     	</table>
