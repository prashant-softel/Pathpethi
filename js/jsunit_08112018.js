...
function loadchanges()
{
	...
	if(arr1[0] == "edit")
	{
		...
		document.getElementById('unit_presentation').value = arr2[15];
		...
		document.getElementById("commercial").value=arr2[11];
		document.getElementById("residential").value=arr2[12];
		document.getElementById("terrace").value=arr2[13];
		document.getElementById("intercom_no").value=arr2[14];
		
		document.getElementById("permanant_add").value=arr2[16];
		document.getElementById("resident_no").value=arr2[17];
		document.getElementById('Year').value = arr2[21];
		jsGetperiods(arr2[21], arr2[22]);
		
		document.getElementById('principle_balance').value = arr2[23];
		document.getElementById('interest_balance').value = arr2[24];
		document.getElementById('bill_subtotal').value = arr2[25];
		document.getElementById('bill_interest').value = arr2[26];
		
		document.getElementById('supp_principle_balance').value = arr2[27];
		document.getElementById('supp_interest_balance').value = arr2[28];
		document.getElementById('supp_bill_subtotal').value = arr2[29];
		document.getElementById('supp_bill_interest').value = arr2[30];
		
		if(arr2[18] == "1")
		{
			document.getElementById('Blocked').checked = true;
			document.getElementById('reason').value = arr2[19];
		}
		else 
		{
		...
		{
			document.getElementById('GSTNoExp').checked = (arr2[20] == 1)? true: false ;
		}
