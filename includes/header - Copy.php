									...
									<a href="servicerequest.php">
										<div><strong>Recent Service Request</strong></div>
                                            ...
                                            { 
                                                ...
                                                {
                                                    if(isset($requests[$m]["details"]) && $requests[$m]["details"] <> "" )
                                                    {
                                                        $msgCounter++;
                                                    ?>
                                                        <div><?php echo $requests[$m]["details"];  ?>
                    ...
                    <div class="sidebar-nav navbar-collapse" style="line-height:4px;line-height:1.3vw;vertical-align:middle;">
                        <ul class="nav" id="side-menu">
							...
							<?php if($_SESSION['module']['service_request'] == "1")
							{
								?>
                            	<li class="active">
                                	<a href="servicerequest.php"><i class="fa  fa-edit  fa-fw"></i>Service Request</a>
                                	<!-- /.nav-second-level -->
                            	</li>
								<?php
							}
                            ...
                            <?php if($_SESSION['module']['classified'] == "1")
							{
								?>
								<li class="active">
									<a href="Ads.php"><i class="fa  fa-tags  fa-fw"></i> Classifieds</a>
									<!-- /.nav-second-level -->
								</li>
								<?php
							}
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
								...
								if($_SESSION['profile']['notification.php'] == 1)
								{ 	?>
                                    <li>
								...
								<?php
                               	...
                               	<?php if($_SESSION['profile']['updateInterest.php'] == 1)
								{	?>  
                                    <li>
                                ...
                                <?php
									...
									if($_SESSION['profile']['PaymentDetails.php'] == 1)
									{
								?>                                
                                    <li>
                                ...
                                <?php
                                    ...
                                    <li>
                                        <a href="sendGeneralMsgs.php">Send General SMS</a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
									<?php if($_SESSION['role'] == "Super Admin" || $_SESSION['role'] == "Admin")
									{
										if($_SESSION['profile']['settings.php'] == 1)
										{
										?>
											<li>
