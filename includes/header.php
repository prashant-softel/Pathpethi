...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<table>
					<tr>
						<td style="text-align:center;font-size:50%" onclick="window.location.href='<?php echo $URL; ?>'">
							<!--<a class="navbar-brand" href="home.php" style="color:#990000;">--><a href="<?php echo $URL; ?>"><img width="60%" src="images/logo_t.gif" /></a>
							<!--</a>-->
						</td>

						<td style="vertical-align:middle"><b>Way2Society.com - Housing Society Social & Accounting Software</b><br />
							<font color="#039"><a href="initialize.php?imp"><?php if (isset($_SESSION['society_id']) && $_SESSION['society_id'] <> 0) {
																				echo $societyName = $m_objHead_S->GetSocietyName($_SESSION['society_id']) . ' - [' . $_SESSION['desc'] . ']';
																			} ?> </a>
								<?php if ($_SESSION['role'] ==  ROLE_SUPER_ADMIN || $_SESSION['role'] == ROLE_ADMIN || $_SESSION['role'] == ROLE_ADMIN_MEMBER) { ?>
									&nbsp;&nbsp;&nbsp;<a href="defaults.php" title="click here to change year"><?php if (isset($_SESSION['society_id']) && $_SESSION['society_id'] <> 0) {
																													echo '[' . $m_objHead_S->GetYearDesc($_SESSION['default_year']) . ']';
																												} ?></a>
								<?php } ?>
			...
			if ($temprole != 'Super Admin' && $temprole != 'Admin') { ?>
									...
									<li>
										<a href="servicerequest.php">
											...
											?>
														...
														<div><?php echo substr($text, 0, 25);
																echo "..."  ?>
														</div>
														<div>
															<span style="float:right;margin-top:-20px;" class="text-muted"><?php echo getDisplayFormatDate($requests[$m]["dateofrequest"]); ?></span>
														</div>
											<?php
													}
												}
											...
											if (sizeof($events) > 0) {
												...
												for ($m = sizeof($events) - 1; $m > sizeof($events) - 3; $m--) {
													...
													if (isset($events[$m]["events_title"])) {
														if ($events[$m]['end_date'] >= $startDate) { //echo $msgCounter;
															$msgCounter++;
											?>
    ...
    -webkit-margin-end: 0px !important;"';
			...
			?>
				...
				<div class="navbar-default sidebar" role="navigation" <?php if ($bIsHide == true) {
																			echo 'style="display:none;"';
																		} else {
																			echo 'style="font-size:10px;font-size:1.00vw;"';
																		} ?>>
					<div class="sidebar-nav navbar-collapse" style="line-height:4px;line-height:1.3vw;vertical-align:middle;">
							...
							?>
								<li>
									...
									<ul class="nav nav-second-level">
										...
										<li>
											<?php $NEFTURL = "neft.php?SID=" . base64_encode($_SESSION["society_id"]) . "&UID=" . base64_encode($_SESSION['unit_id']); ?>
											<a href="<?php echo $NEFTURL; ?>">Record NEFT Payment</a>
										</li>
									</ul>
								</li>
							<?php
						...
						?>
						<?php if ($_SESSION['module']['directory'] == "1") {
						?>
							<li>
								<a href="#">
				...
				<div class="navbar-default sidebar" role="navigation" <?php if ($bIsHide == true) {
					...
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							...
							<li>
								<a href="#">
									<i class="fa  fa-building  fa-fw"></i>Banking
									<span class="fa arrow">
									</span>
								</a>
								<ul class="nav nav-second-level">
									<li>
										<a href="list_member.php?scm">Members</a>
									</li>
									<li>
										<a href="pp_deposits.php">Deposits</a>
									</li>
									<li>
										<a href="pp_loan.php">Loans</a>
									</li>
									<li>
										<a href="daily_collection.php">Daily Collection</a>
									<li>
										<a href="pp_receipts.php">Receipts</a>
									</li>
									<li>
										<a href="agents_view.php">Agent List</a>
									</li>
								</ul>
