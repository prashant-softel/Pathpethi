...
<?php } ?>
	...
	<tr><td><br></td></tr>
        	...
        	<!--<td valign="left"><span style="margin-left: 4%;">&nbsp;</span><span  style="margin-left: 3%;">Record NEFT </span><span  style="margin-left: 80px;">&nbsp; : &nbsp;</span>
		...
		<span style="margin-left:4%;">	<select name="int_method" id="int_method" class="field_select" value="<?php echo $_REQUEST['int_method'];?>">
            		<OPTION VALUE="<?php echo INTEREST_METHOD_DELAY_DUE; ?>">Delay After Due Date</OPTION>
					<OPTION VALUE="<?php echo INTEREST_METHOD_DELAY_SINCE_BILLING_DAYS; ?>">Delay Since Start of Billing Cycle</OPTION>
                ...
                <div id="demo2_tip" class="popuptext" style="text-align:left; width:21vw;">
                      <dl style="margin-left:10px;">
                          ...
                          <dt><br/></dt> 
						  <dt>2. Delay Since Start of Billing Cycle</dt>
                          <dd>- Interest will be calculated on number of days Since billing period start date.</dd>
                          <dt><br/></dt> 
                          <dt>3. Full Month</dt>
                          <dd>- Interest will be calculated from first day of the month.</dd>
                          <dt>4.Full Cycle</dt>
                          <dd>- Interest will be calculated on full billing period</dd>
                    </dl>
                </div>
             </button>
             </span>
        ...
        <tr>
          ...
          <tr>
			...
			<span style="margin-left:4%;"><select name="rebate_method" id="rebate_method" class="field_select" value="<?php echo $_REQUEST['rebate_method'];?>" >
					...
					<OPTION VALUE="<?php echo REBATE_METHOD_WAIVE_MENTION_AMOUNT; ?>"> Waive Interest If Arrears Upto The Mentioned Amount</OPTION>
		...
		<span  style="margin-left: 4%;"><input type="checkbox" name="apply_NEFT_member" id="apply_NEFT_member" value="1" style="    margin: 0px 0 0;"/></span><span style="margin-left: 2%;">&nbsp;</span><span style="color: red;"><!--NEFT Disabled for Members--> </span></td>
         ...
         <tr>
        	<td valign="left"><span style="margin-left:4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 3%;">Send Reminder</span><span style="margin-left:80px;">&nbsp; : &nbsp;</span>
         ...
         <tr>
          ...
          <tr>
        	<td valign="left"><span style="margin-left:4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 3%;">Send Payment Received<br></span><span style="margin-left:8%;">Notification To Members </span><span style="margin-left: 6%;">&nbsp; : &nbsp;</span>
         ...
         <tr>
        	<td valign="left"><span style="margin-left:4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 3%;">Send Payment Voucher<br></span><span style="margin-left:8%;">Email To Committee Daily</span><span style="margin-left: 6%;">&nbsp; : &nbsp;</span>
        ...
        <tr>
        	<td valign="left"><span style="margin-left:4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 3%;">Send Payment Voucher<br></span><span style="margin-left:8%;">SMS To Committee Daily</span><span style="margin-left: 6%;">&nbsp; : &nbsp;</span>
