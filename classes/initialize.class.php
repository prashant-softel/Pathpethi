...
class initialize
{
	...
	public function sendNewUserActivationEmail($email, $name, $sAccountActivationCode ="", $GetReturnStatus ="", $SocietyID = "")
	{
		...
		//$EMailID = "rohit.shinde2010@gmail.com";
		//		$Password = "Vertex04!";
	...
	public function generateActivationEmailTemplate($bShow = false,$email , $name,$sAccountActivationCode = "", $bHideRegistrationVerbaige = 0)
	{
		...
		//	echo "Code: ".$sAccountActivationCode;
		  ...
		  {
			$newUserUrl = "http://way2society.com/newuser.php?reg&u=".$email."&c=".$sAccountActivationCode."&n=".$name."&tkn=".$encryptedEmail;
		 ...
		 else
		 {
		  ...
		  if($bShow == true)
		  {
			$mailBody .= '<br /><br /><table width="100%" cellspacing="0" cellpadding="0" border="0">
										...
										<tr><td></td></tr>';
										$mailBody .='<br /><tr><td><br></td></tr>                   
										<tr><td colspan="3">Alternativaly, You can install our Android mobile App "Way2Society" from Google Playstore using following Activation Code when prompted during installation.</td></tr>
                                       ...
                                       <td align="center" style="width:160px;height: 45px;"><span style="font-size:16px">Access Code :</span></td>
							...
							<img src="http://way2society.com/images/active1.jpg" width="300px" height="160px" alt="image instead of video" />
										...
										<tr><td colspan="3">If you have any query or concern, please contact us at <a href="mailto:cs@way2society.com" target="_blank">cs@way2society.com</a></td></tr>
										</center></tbody></table>';	
		  }
		  else
		  {
	...
	{
		echo $sqlCheck = "select count(member_id) as cnt from login where member_id = '" . $email . "'";
		$resultCheck = $this->m_dbConn->select($sqlCheck);	
		if($resultCheck[0]['cnt'] > 0)
		{
			return true;	
