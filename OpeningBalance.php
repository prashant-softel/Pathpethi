...
<tr>
    <td valign="top" style="border-right:1px solid black;">
		...
		*/
		...
		echo '<ul><li><label><span style="border:none;width:270px;"><a href = "IncomeStmt.php">Profit & Loss A/c</a></span><span style="border:none;width:50px;text-align:right;"><a href = "IncomeStmt.php">'.number_format($ProfitnLoss,2).'</a></span></label></li></ul>';
		 echo '</div>';
        ?>
    </td>
    <td valign="top">
